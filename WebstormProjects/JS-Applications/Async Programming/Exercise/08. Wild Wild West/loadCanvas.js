function loadCanvas(player){
    ...
    function drawCanvas(mouseX, mouseY){
        ...
        ctx.fillText(`Player: ${player.name}`, 550, 25);
        ctx.fillText(`Money: ${player.money}`, 550, 50);
        ctx.fillText(`Bullets: ${player.bullets}`, 550, 75);
        ...
        ctx.drawImage(sight, mouseX, mouseY,40,40);
    }
