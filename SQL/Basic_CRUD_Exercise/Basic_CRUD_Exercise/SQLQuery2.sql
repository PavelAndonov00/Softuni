...
SELECT TOP(5) FirstName, LastName
 ...
 BACKUP DATABASE SoftUni TO DISK = N'E:\softuni.bak'

 UPDATE Employees
SET Salary *= 1.12
WHERE DepartmentID IN(1, 2, 4, 11)

SELECT Salary FROM Employees WHERE DepartmentID IN (1, 2, 4, 11) ORDER BY Salary DESC

DROP DATABASE SoftUni

RESTORE DATABASE SoftUni FROM DISK = N'E:\softuni.bak'
